...
public class c6_CombiningPublishers extends CombiningPublishersBase {
    ...
    public void task_executor() {
        ...
        tasks = taskExecutor().flatMap(m -> m);
    ...
    public void streaming_service() {
        ...
        messageFlux = streamingService().flatMapMany(f -> f);
    ...
    public void i_am_rubber_you_are_glue() {
        ...
        numbers = numberService1().mergeWith(numberService2());
    ...
    public void task_executor_again() {
        //todo: feel free to change code as you need
        Flux<Void> tasks = null;
        tasks = taskExecutor().concatMap(t -> t);
    ...
    public void mail_box_switcher() {
        ...
        myMail = mailBoxPrimary().switchOnFirst((s, f) -> {
...
*/
        ...
        successful = openFile().then(writeToFile("0x3522285912341")).then(closeFile())
                .thenReturn(true);
    ...
    public void car_factory() {
        ...
        producedCars = carChassisProducer().zipWith(carEngineProducer(), (chassis, engine) -> new Car(chassis, engine));
    ...
    public Mono<String> chooseSource() {
        ...
        return Mono.defer(()->{
            String s = sourceRef.get();
            if (s.equals("A")) return sourceA();
            if (s.equals("B")) return sourceB();
            return Mono.empty();
        });
    }
    ...
    public void cleanup() {
        ...
        Flux<String> stream = Flux.usingWhen(StreamingConnection.startStreaming(),Function.identity(),(s)->StreamingConnection.closeConnection());
